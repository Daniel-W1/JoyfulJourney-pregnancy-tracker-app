...
class _$_AppointmentEntity implements _AppointmentEntity {
  ...
  @override
  String toString() {
    return 'AppointmentEntity(id: $id, title: $title, description: $description, date: $date, time: $time, user_id: $user_id, status: $status)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, description, date, time, user_id, status);
...
abstract class _AppointmentEntity implements AppointmentEntity {
  const factory _AppointmentEntity(
      ...
      required final String status}) = _$_AppointmentEntity;
